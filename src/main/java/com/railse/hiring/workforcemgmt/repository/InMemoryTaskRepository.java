...
public class InMemoryTaskRepository implements TaskRepository {
    ...
    Map<Long, List<TaskComment>> commentStore = new HashMap<>();
    ...
    @Override
    public List<TaskActivity> getActivityForTask(Long taskId) {
        return activityStore.getOrDefault(taskId, new ArrayList<>());
    }
